...
class AutohomeSpider(object):
    ...
    def query_data(self):
        city_id = [440100,440200,440300,440400,440500,440600,440700,440800,440900,441200,441300,441400,441500,441600,441700,441800,441900,442000,445100,445200,445300]
        return city_id
