...
class AutohomeSpider(object):
    ...
    def query_data(self):
        city_id = [360100,360200,360300,360400,360500,360600,360700,360800,360900,361000,361100]
        # city_id = [360200,360300,360400,360500,360600,360700,360800,360900,361000,361100]
        return city_id
